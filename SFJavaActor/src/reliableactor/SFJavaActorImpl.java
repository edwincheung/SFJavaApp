...
*/
@ActorServiceAttribute(name = "SFJavaActorService")
@StatePersistenceAttribute(statePersistence = StatePersistence.Persisted)
public class SFJavaActorImpl extends FabricActor implements SFJavaActor {
    private Logger logger = Logger.getLogger(this.getClass().getName());

    public SFJavaActorImpl(FabricActorService actorService, ActorId actorId){
